...
var (
	tplKeepAChangelog = &TemplateStyleFormat{
		...
		preview: "https://github.com/git-changelog/example-type-scope-subject/blob/master/CHANGELOG.kac.md",
	}
	tplStandard = &TemplateStyleFormat{
		display: "standard",
		preview: "https://github.com/git-changelog/example-type-scope-subject/blob/master/CHANGELOG.standard.md",
	}
	tplCool = &TemplateStyleFormat{
		display: "cool",
		preview: "https://github.com/git-changelog/example-type-scope-subject/blob/master/CHANGELOG.cool.md",
	}
