    ...
    client := &mockClient{
        ReturnExec: func(subcmd string, args ...string) (string, error) {
            ...
            return strings.Join([]string{
                "",
                "refs/tags/v2.0.4-beta.1@@__CHANGELOG__@@Release v2.0.4-beta.1@@__CHANGELOG__@@Thu Feb 1 00:00:00 2018 +0000@@__CHANGELOG__@@",
                "refs/tags/4.4.3@@__CHANGELOG__@@This is tag subject@@__CHANGELOG__@@@@__CHANGELOG__@@Fri Feb 2 00:00:00 2018 +0000",
                "refs/tags/4.4.4@@__CHANGELOG__@@Release 4.4.4@@__CHANGELOG__@@Fri Feb 2 10:00:40 2018 +0000@@__CHANGELOG__@@",
                "refs/tags/5.0.0-rc.0@@__CHANGELOG__@@Release 5.0.0-rc.0@@__CHANGELOG__@@Sat Feb 3 12:30:10 2018 +0000@@__CHANGELOG__@@",
                "refs/tags/hoge_fuga@@__CHANGELOG__@@Invalid semver tag name@@__CHANGELOG__@@Mon Mar 12 12:30:10 2018 +0000@@__CHANGELOG__@@",
                "hoge@@__CHANGELOG__@@",
            }, "\n"), nil
        },
    }
